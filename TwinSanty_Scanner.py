...
def main():
    ...
    for domain in domains_to_scan:
        ...
        if args.bruteforce:
            # (brute-force logic remains the same)
            pass
    ...
    for hosts in input_ip_map.values(): # This handles the original IP-based input format
        for h in hosts:
            all_hosts.add(h.lower())
    all_hosts.update(discovered_subs) # Add the newly discovered subdomains
